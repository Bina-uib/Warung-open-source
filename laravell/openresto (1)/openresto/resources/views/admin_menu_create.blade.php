...
<head>
    ...
    <title>Tambah Menu Baru - OpenResto</title>
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0/dist/css/bootstrap.min.css" rel="stylesheet">
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/cropperjs/1.5.13/cropper.min.css">
</head>
<body class="bg-light">
    <nav class="navbar navbar-dark bg-dark px-4 shadow mb-4">
        <span class="navbar-brand mb-0 h1">Tambah Menu Baru</span>
                    ...
                    <div class="card-body p-4">
                        <form action="{{ route('admin.menus.store') }}" method="POST" enctype="multipart/form-data" id="menuForm">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="name" id="name" class="form-control" required placeholder="Contoh: Nasi Goreng Spesial">
                            </div>
                            <div class="mb-3">
                                <label for="price" class="form-label fw-bold">Harga (Rp)</label>
                                <input type="number" name="price" id="price" class="form-control" required placeholder="Contoh: 25000">
                            </div>
                            <div class="mb-3">
                            ...
                            <div class="mb-3 d-none" id="cropperWrapper">
                                <label class="d-block mb-2 fw-bold">Sesuaikan Gambar (Crop 4:3)</label>
